=== WP Restore and Enable Classic Widgets Plugin ===
...
Tags: restore widgets, classic widgets, enable classic widgets, Old widgets screen, old widgets UI
Author: Bill Minozzi
...
> Restore and enable the previous WordPress classic widgets settings screens and disables the Gutenberg block editor from managing widgets.
